...
/**
 * Разжимает короткий звук в готовый `AudioBuffer` до старта кадрового цикла — «Звук» →«Два вида звука»: звук события живёт в памяти страницы готовыми отсчётами. Копия байт
