//! Runtime sound behavior — «Звук в шаге и кадре» + «Звук снаружи движка»: the step raises
...
// временем честно срабатывает все десять раз («Звук в данных игры» → «Звук — не счётчик»).
// -------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------
// Музыка экрана и переключатель звука — «Звук снаружи движка» / «Звук в данных игры».
// -------------------------------------------------------------------------------------------
...
// вызов apply_command — «Экраны и состояние» → «Клавиша экрана» покрыт этим путём и для
